...
exports.createComment = async (req, res) => {
    ...
    try {
      ...
      console.error(error);
      return res.status(500).json({ message: "Erro ao criar o comentário.", error });
    }
  };
...
exports.editComment = async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    return res.status(500).json({ message: "Erro ao editar comentário.", error });
  }
};
...
exports.deleteComment = async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    return res.status(500).json({ message: "Erro ao deletar comentário.", error });
  }
};
...
exports.likeComment = async (req, res) => {
    ...
    try {
      ...
      res.status(200).json({ message: "Comentário curtido com sucesso.", comment });
    } catch (error) {
